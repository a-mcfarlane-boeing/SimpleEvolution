...
Max_energy_loss_rate = 0.2 #units per second
...
class Bot:
    ...
    def __init__(self, canvas, simulation_time, name = "exampleBot", max_speed=Max_speed,max_view_angle=Max_view_angle,max_energy=Max_energy_reserve):
        ...
        #brain
        self.net = brain.Brain(Num_of_neurons,Num_of_connections,6)
    ...
    def think(self):
        ...
        self.net.outputs["i3"] = self.right_angle_percent
        self.net.outputs["i4"] = self.left_angle_percent
    ...
    def save_attributes(self, file_location = None):
        if file_location == None:
    ...
    def load_attributes(self,file_location):
